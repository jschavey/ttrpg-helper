...
- **Shadowdark**: notation `<N>D<sides>` or with modifier (e.g. `D20`, `2D6+1`, `D20-3`, `2D6+1D4`). Supports mixed pools (multiple die types summed) and flat modifiers. Negative die counts subtract from the total.
